'''
this script is used to analysis the distribution of the confidence and time difference
of the wrong deleted flow entry from the txt file generated by lru/ml simulation
'''
import re
